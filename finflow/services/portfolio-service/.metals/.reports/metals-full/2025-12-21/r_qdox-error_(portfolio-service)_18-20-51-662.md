error id: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingResponse.java
file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingResponse.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingResponse.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingResponse.java
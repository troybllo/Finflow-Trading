error id: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingRequest.java
file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingRequest.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingRequest.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/finflow/portfolio/dto/HoldingRequest.java
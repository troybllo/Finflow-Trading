error id: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/application/PortfolioService.java
file://<WORKSPACE>/src/main/java/com/finflow/portfolio/application/PortfolioService.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/application/PortfolioService.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/finflow/portfolio/application/PortfolioService.java
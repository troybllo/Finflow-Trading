error id: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/domain/User.java
file://<WORKSPACE>/src/main/java/com/finflow/portfolio/domain/User.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/finflow/portfolio/domain/User.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/finflow/portfolio/domain/User.java
...
/**
 * Request DTO for updating external account settings. All fields are optional -
 * only provided fields will be updated.
 */
public record UpdateExternalAccountRequest(
		@Size(max = 100, message = "Account name must not exceed 100 characters") String accountName,
	...
	public boolean hasUpdates() {
		return accountName != null || syncEnabled != null || accessToken != null || refreshToken != null
